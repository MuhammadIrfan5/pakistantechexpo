...
export const CarouselArticles= props => {
    const { Image1 } = props;
  ...
  return (
    <Division divVariant=" w-full flex flex-row overflow-hidden	 justify-center items-center lg:gap-2 gap-1 py-2 bg-blue-20 ">
        <Division divVariant="flex flex-row w-full">
          <Carousel
              swipeable={true}
              draggable={true}
              showDots={false}
              ...
              removeArrowOnDeviceType={["tablet", "mobile","destop"]}
              // arrows = {false}
